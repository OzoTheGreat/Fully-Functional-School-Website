    ...
    <header>
      <div class="navbar-fixed">
        <nav class="navbar white">
          <div class="nav-wrapper"><a href="#!" class="brand-logo grey-text text-darken-4">Minors</a>
        ...
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            ...
            <li class="bold waves-effect"><a class="collapsible-header">Calendar<i class="material-icons chevron">chevron_left</i></a>
              ...
              <li class="bold waves-effect active"><a class="collapsible-header">Major/Minors<i class="material-icons chevron">chevron_left</i></a>
                <div class="collapsible-body">
                  <ul>
                    <li><a href="majors.php" class="waves-effect">Majors<i class="material-icons">school</i></a></li>
                    <li><a href="minors.php" class="waves-effect active">Minors<i class="material-icons">history_edu</i></a></li>
                  </ul>
                </div>
              </li>
    ...
    <div class="col s12">
      <h2 class="section-title">Minors</h2>
		...
		<th>Department</th>
            ...
            require "db.php";
            try {
                $stmt = $connect->prepare("SELECT minor.minorName, dept.department FROM minor INNER JOIN dept on minor.departmentID = dept.departmentID");
                $stmt->execute();
