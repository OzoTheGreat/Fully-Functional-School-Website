...
require 'db.php';
$id = $_GET['id'];
$sql = 'SELECT * FROM course LEFT JOIN dept ON course.departmentID = dept.departmentID LEFT JOIN prerequisite ON prerequisite.courseID =course.courseID WHERE prerequisite.regCourseID =:id';
...
<html lang="en">
  <head>
    ...
    <title>Courses - Prerequisites</title>
  ...
  <header>
    <div class="navbar-fixed">
      <nav class="navbar white">
        <div class="nav-wrapper"><a href="#!" class="brand-logo grey-text text-darken-4">Prerequisites</a>
