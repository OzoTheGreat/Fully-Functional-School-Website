<?php
  ...
  if(isset($_SESSION["username"])&& $_SESSION["rank"] =='Admin')
  {
    ...
    if(isset($_POST["newcourseid"]) && isset($_POST["newprofessor"]) && isset($_POST["newsection"])&& isset($_POST["newroom"])&& isset($_POST["newtime"])&& isset($_POST["newday"])&& isset($_POST["newseats"]))
    {
      ...
      $sql ='INSERT INTO timeslot (timeslot.periodID,timeslot.dayID) VALUES(:period,:day)';
      $statement= $connect->prepare($sql);
      if($statement->execute([':period'=>$newtime,
                              ':day'=>$newday]))
          {
            $sql ='SELECT * FROM timeslot ORDER BY timeSlotID DESC';
            $statement= $connect->prepare($sql);
            $statement->execute();
            $row =$statement->fetch(PDO::FETCH_ASSOC);
            $timeslot = $row["timeSlotID"];
            $sql ='INSERT INTO class (class.roomID,class.seatsAvailable,class.courseID,class.timeslotID,class.semesterID,class.facultyID,class.section) VALUES(:id,:seats,:course,:timeslot,:semester,:faculty,:section)';
            $statement= $connect->prepare($sql);
            if ($statement->execute([':id'=>$newroom,
                                     ':seats'=>$newseats,
                                     ':course'=>$newcourseid,
                                     ':timeslot'=>$timeslot,
       ...
       <div class="section container">
         <div class="row">
           <div class="col s12 m12">
             <span class="settings-title">Create a Class</span>
             <p>Here you can create a class</p>
           </div>
           <div class="row">
             <div class="col s12 m12">
                     ...
                     <div class="collapsible-header">
                       <div class="col s12 m12">
                         ...
                         <div class="input-field col s2">
                           <select name="newsemester" id="newsemester">
                             <option>--</option>
