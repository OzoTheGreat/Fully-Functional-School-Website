          ...
          <div class="col s12">
            <div class="col s12">
              <div class="settings-group">
                <div class="setting center grey lighten-2 hoverable">
              ...
              <div class="progress">
                <div class="determinate grey darken-2" style="width: <?php echo $percent; ?>%"></div>
              </div>
              </div>
              <ul class="collection with-header hoverable">
                <li class="collection-header center grey lighten-2"><h4 class="section-title">Courses Completed</h4></li>
                <?php
              ...
              <ul class="collection with-header hoverable">
                <li class="collection-header center grey lighten-2"><h4 class="section-title">In Progress</h4></li>
                <?php
              ...
              if(isset($major["majorID"]))
              {
                ...
                echo '<li class="collection-header center grey lighten-2"><h4 class="section-title">Requirements For Major '.$major["majorName"].'</h4></li>';
              ...
              {
                echo '<ul class="collection with-header hoverable">';
                echo '<li class="collection-header center grey lighten-2"><h4 class="section-title">Requirements For Minor '.$minor["minorName"].'</h4></li>';
