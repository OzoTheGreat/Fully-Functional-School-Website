              ...
              <li class="bold waves-effect active"><a class="collapsible-header">Student Records<i class="material-icons chevron">chevron_left</i></a>
                <div class="collapsible-body">
                  <ul>
                    ...
                    <li><a href="changemm.php?id=<?php echo $_SESSION["studentID"]; ?>" class="waves-effect active">Change Major/Minor<i class="material-icons">edit</i></a></li>
        ...
        <div class="row">
          <div class="col s12">
            <div class="col s12">
              ...
              <span><p>Here you can change the current Major or Minor for Student <?php echo $_SESSION["studentName"]; ?>.</p></span>
              <div class="col 12 m12 center">
                <span><p>Select The Major or Minor you'd like to change to and then confirm with the <i class="grey-text lighten-2">CHANGE</i> button</p></span>
                <form method="POST">
                  <div class="col s6">
                    <span>Major</span>
