            ...
            <li class="bold waves-effect active"><a class="collapsible-header">Faculty<i class="material-icons chevron">chevron_left</i></a>
              <div class="collapsible-body">
                <ul>
                  ...
                  <li><a href="viewcourses.php?id=<?php echo $_SESSION["facultyID"]; ?>" class="waves-effect active">View Courses<i class="material-icons">dvr</i></a></li>
                  </ul>
                </div>
              </li>
        ...
        <div class="row">
          <div class="col s12">
            <div class="col s12 center">
                <span><p>Faculty Classes For Fall 2021</p></span>
            </div>
            <?php
              while($result= $statement->fetch(PDO::FETCH_ASSOC))
              {
                echo '<ul class="collection with-header hoverable">';
                echo '<li class="collection-header center grey lighten-3"><h4 class="section-title">'.$result["courseTitle"].' - '.$result["CRN"].'</h4></li>';
                echo '<li class="collection-item">CRN : '.$result["CRN"].'</li>';
                echo '<li class="collection-item">Room: '.$result["roomID"].'</li>';
                echo '<li class="collection-item">Section: '.$result["section"].'</li>';
                echo '</ul>';
              }
            ?>
