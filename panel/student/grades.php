<?php
 ...
 else
 {
   ...
   $query1 ='SELECT * FROM attendance WHERE attendance.studentID ="'.$_SESSION["studentID"].'"';
   ...
   <html lang="en">
     ...
     <body class="has-fixed-sidenav">
               ...
               <li class="bold waves-effect active"><a class="collapsible-header">Records<i class="material-icons chevron">chevron_left</i></a>
                 <div class="collapsible-body">
                   <ul>
                     ...
                     <li><a href="#" class="waves-effect active">Grades<i class="material-icons">grading</i></a></li>
       ...
       <nav class="navbar nav-extended no-padding">
         <div class="nav-wrapper"><a href="#" class="brand-logo">Grades</a><a href="#" data-target="sidenav-left" class="sidenav-trigger"><i class="material-icons">menu</i></a>
       ...
       <main>
         ...
         <ul class="collection with-header hoverable">
           <li class="collection-header center red lighten-2"><h4 class="section-title">Grades for Fall 2021</h4></li>
         <?php
          while($row= $statement->fetch(PDO::FETCH_ASSOC))
          {
            echo '<li class="collection-item">'.$row["courseTitle"].'</br> Grade '.$row["grade"];
