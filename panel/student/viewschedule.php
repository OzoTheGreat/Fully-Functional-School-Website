   ...
   <html lang="en">
     ...
     <body class="has-fixed-sidenav">
       ...
       <nav class="navbar nav-extended no-padding">
         <div class="nav-wrapper"><a href="#" class="brand-logo">Course Schedule</a><a href="#" data-target="sidenav-left" class="sidenav-trigger"><i class="material-icons">menu</i></a>
               ...
               <div class="col s12">
                  <?php
                    while($result = $statement->fetch(PDO::FETCH_ASSOC))
                    {
                      ...
                      echo '<li class="collection-header center red lighten-2"><h4 class="section-title">'.$result["courseTitle"].'</h4></li>';
