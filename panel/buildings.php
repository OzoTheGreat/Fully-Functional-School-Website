    ...
    <header>
      <div class="navbar-fixed">
        <nav class="navbar white">
          <div class="nav-wrapper"><a href="#!" class="brand-logo grey-text text-darken-4">Buildings</a>
              ...
              <li class="bold waves-effect active"><a class="collapsible-header">Department/Building<i class="material-icons chevron">chevron_left</i></a>
                <div class="collapsible-body">
                  <ul>
                    ...
                    <li><a href="buildings.php" class="waves-effect active">Buildings<i class="material-icons">apartment</i></a></li>
                  </ul>
                </div>
              </li>
            </li>
    ...
    <div class="col s12">
      <h2 class="section-title">Buildings</h2>
        <div id='test2' class='row'>
            ...
            require "db.php";
            try {
                $stmt = $connect->prepare("SELECT building.buildingName, building.buildingType FROM building");
                $stmt->execute();
