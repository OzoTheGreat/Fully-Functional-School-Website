    ...
    <header>
      <div class="navbar-fixed">
        <nav class="navbar white">
          <div class="nav-wrapper"><a href="#!" class="brand-logo grey-text text-darken-4">Master Schedule</a>
    ...
    <div class="col s12">
      ...
      <div class="center col 4">
        <form method="POST">
          ...
          <div class="col 4">
            <button class="btn waves-effect waves-light teal darken-1" type="submit" name="action">Change
