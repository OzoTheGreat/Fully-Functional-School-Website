...
(function ($) {
  $(document).ready(function(){
     ...
     *    DataTables    *
     ********************/
     var table = $('#defualt-table').DataTable({
       'language': {
         'search': '',
...
/*
     ...
     */
/*
    var dataTable = $('#masterScheduleTable').DataTable({
              "processing":true,
              "serverSide":true,
              "order":[],
              "ajax":{
               url:"../panel/scripts/fetch.php",
               type:"POST"
            },
          "columnDefs":[
             {
     ...
     *     Calendar     *
     ********************/
    var augustAdvising = new Date(2021,7,23,0,0,0).toISOString().substr(0,10);
    var residenceHalls = new Date(2021,7,28,0,0,0).toISOString().substr(0,10);
    var diningHalls = new Date(2021,7,31,0,0,0).toISOString().substr(0,10);
    var firstDay = new Date(2021,8,1,0,0,0).toISOString().substr(0,10);
    var firstAddDrop = new Date(2021,8,1,0,0,0).toISOString().substr(0,10);
    var laborDay = new Date(2021,8,6,0,0,0).toISOString().substr(0,10);
    var columbusDay = new Date(2021,9,11,0,0,0).toISOString().substr(0,10);
    var midtermStart = new Date(2021,9,16,0,0,0).toISOString().substr(0,10);
    var midtermEnd = new Date(2021,9,24,0,0,0).toISOString().substr(0,10);
    var midterm = new Date(2021, 9, 25, 0,0,0).toISOString().substr(0,10);
    var registration = new Date(2021,10,1,0,0,0).toISOString().substr(0,10);
    var novDiningHall = new Date(2021,10,23,0,0,0).toISOString().substr(0,10);
    var thanksgivingStart = new Date(2021,10,24,0,0,0).toISOString().substr(0,10);
    var thanksgivingEnd = new Date(2021,10,28,0,0,0).toISOString().substr(0,10);
    var novResume = new Date(2021,10,29,0,0,0).toISOString().substr(0,10);
    var decStudyStart = new Date(2021,11,14,0,0,0).toISOString().substr(0,10);
    var decStudyEnd = new Date(2021,11,15,0,0,0).toISOString().substr(0,10);
    var decFinalStart = new Date(2021,11,16,0,0,0).toISOString().substr(0,10);
    var decFinalEnd = new Date(2021,11,22,0,0,0).toISOString().substr(0,10);
    var dormsEnd = new Date(2021,11,22,0,0,0).toISOString().substr(0,10);


    var eventData = [
      {
        title: 'Advising Continues for All Students',
        start: augustAdvising
      },
      {
        title: 'Residence Halls Open for All Students',
        start: residenceHalls
      },
      {
        title:'Dining Halls Open for All Students',
        start: diningHalls
      },
      {
      ...
      {
        title: 'Columbus Day-no classes, offices closed',
        start: columbusDay
      },
      {
        title: 'Mid-Term week',
      ...
      {
        title: 'Registration for Spring 2022 Begins',
        start: registration
      },
      {
        title: 'Dining Hall closes after dinner',
        start: novDiningHall
      },
      {
        title: 'Thanksgiving Recess -no classes',
        start: thanksgivingStart,
        end: thanksgivingEnd
      },
      {
      ...
      {
        title: 'Fall Semester ends after last examination',
        start: decFinalEnd
      },
      {
        title: 'Residence Halls close at 10pm',
        start: dormsEnd
      }
      ];
