    ...
    <header>
      <div class="navbar-fixed">
        <nav class="navbar white">
          <div class="nav-wrapper"><a href="#!" class="brand-logo grey-text text-darken-4">Courses</a>
          ...
          <ul class="collapsible collapsible-accordion">
            <li class="bold waves-effect active"><a class="collapsible-header">Courses<i class="material-icons chevron">chevron_left</i></a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="courses.php" class="waves-effect active">Courses<i class="material-icons">school</i></a></li>
      ...
      <h2 class="section-title">Courses</h2>
        <div id='test2' class='row'>
          <div class='col s12'>
            ...
            require "db.php";
            try {
                $stmt = $connect->prepare("SELECT course.courseID, dept.department, course.courseTitle, course.courseCredit FROM course INNER JOIN dept on course.departmentID = dept.departmentID");
                $stmt->execute();
                while($row =$stmt->fetch(PDO::FETCH_ASSOC)){
                            ...
                            echo '<td><a href="checkPrerequisites.php?id='.$row["courseID"].' ">Check Prequisites</a></td>';
                            echo '</tr>';
                }
