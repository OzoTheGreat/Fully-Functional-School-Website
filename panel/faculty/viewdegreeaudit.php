            ...
            <li class="bold waves-effect active"><a class="collapsible-header">Student Records<i class="material-icons chevron">chevron_left</i></a>
              <div class="collapsible-body">
                <ul>
                  ...
                  <li><a href="viewdegreeaudit.php?id=<?php echo $_SESSION["studentID"]; ?>" class="waves-effect active">View Degree Audit<i class="material-icons">dvr</i></a></li>
          ...
          <div class="col s12">
            <div class="col s12">
              <div class="settings-group">
                <div class="setting center yellow lighten-2 hoverable">
                  <h5 class="section-title">Degree Audit For - <?php echo $_SESSION["studentName"]; ?></h5>
                </div>
                <div class="center">
                <div class="col s3">
              ...
              <div class="progress">
                <div class="determinate yellow darken-2" style="width: <?php echo $percent; ?>%"></div>
              </div>
              </div>
              <ul class="collection with-header hoverable">
                <li class="collection-header center yellow lighten-2"><h4 class="section-title">Courses Completed</h4></li>
                <?php
              ...
              <ul class="collection with-header hoverable">
                <li class="collection-header center yellow lighten-2"><h4 class="section-title">In Progress</h4></li>
                <?php
              ...
              if(isset($major["majorID"]))
              {
                ...
                echo '<li class="collection-header center yellow lighten-2"><h4 class="section-title">Requirements For Major '.$major["majorName"].'</h4></li>';
              ...
              {
                echo '<ul class="collection with-header hoverable">';
                echo '<li class="collection-header center yellow lighten-2"><h4 class="section-title">Requirements For Minor '.$minor["minorName"].'</h4></li>';
