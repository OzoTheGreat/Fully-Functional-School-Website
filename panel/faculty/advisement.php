<?php
  ...
  {
    $sql = "SELECT * FROM advisor INNER JOIN student ON advisor.studentID = student.studentID INNER JOIN user ON student.userID = user.userID WHERE advisor.facultyID =:facultyID";
    $statement =$connect->prepare($sql);
    $statement->execute([':facultyID'=>$_SESSION["facultyID"]]);
  }
 ?>
 <!DOCTYPE html>
 <html lang="en">
   ...
   <body class="has-fixed-sidenav">
             ...
             <li class="bold waves-effect active"><a class="collapsible-header">Student Records<i class="material-icons chevron">chevron_left</i></a>
               <div class="collapsible-body">
                 <ul>
                   ...
                   <li><a href="advisement.php" class="waves-effect active">Advisement<i class="material-icons">people_alt</i></a></li>
                 </ul>
               </div>
             </li>
           </ul>
     ...
     <nav class="navbar nav-extended no-padding">
       <div class="nav-wrapper"><a href="#" class="brand-logo">Advisement</a><a href="#" data-target="sidenav-left" class="sidenav-trigger"><i class="material-icons">menu</i></a>
       ...
       <div class="container">
         <div class="row">
           <div class="col s12">
             <div class="col s12">
               <h4>Advisees</h4>
               <span><p>Here you can view all of your advisees if you have any. You can view their student account from here aswell; Such as Degree Audit and Transcript to help better assist you.</p></span>
